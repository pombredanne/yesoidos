label chapter2:
    ...
    mom "Even afterwards, he would help other scientists with their work."
    ...
    "Pirkei Avos. Chovos Halevavos."
    "Rambam. Rabi Yochanan ben Zakkai. Hillel."
    ...
    "It was just before he moved away."
    ...
    "I learned how to keep kosher, to observe the Shabbos, how to tie tsitsis."
    ...
    "The books of Yehoshuä, Shmuël and Melachim. Amos, Tehilim, Esther and Mishlei."
    "The classic commentaries of Rashi and Radak, the Aramaic translation of Onkelos."
    "But, sometimes..."
    "I saw glimmers of deep secrets."
    "Sometimes, I read about Gematria. Like in the Kitzur Shulchan Aruch, where the author interrupted his legal code to perform numerology with the letters of the Alef-Beis."
...
#########################
    ...
    show text(bookText("Raban Gamliel, the son of Rabi Yehuda HaNasi says, \"Torah is beautiful with a worldly occupation, for the simultaneous exertions make sin forgotten...\""))
    with dissolve
    pause
    ...
    "I just can't go further, unless I'm willng to vaporize my brain."
