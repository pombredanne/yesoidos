label chapter2:
    ...
    "Zusha moved away. To his son's family - Oklahoma City, I think."
    ...
    "Even the grass and the sky don't seem to shine as brightly as in my memories."
    shout "{i}Do you still even want to be a tsadik?{/i}"
    me "..."
    me "Yes... I think."
    me "Well, I {i}want to{/i} want to be one..."
    me "But I don't know."
    me " I guess other things have pushed it aside."
    ...
    me "..."
    inner "Not to say, mind, that you can't also have other abilities. It's just that everything must {i}focus.{/i}"
    ...
    # But it's not wise to give up everything all at once. Move slowly. Transform rather than reject where possible.
    me "..."
    me "Yes, I do."
    inner "Like music."
    me "Yes, but..."
    ...
    inner "It's okay not to choose music. But depending other people's validation won't lead you to a good place."
    me "I see."
    inner "But okay, so you won't devote your life to music. I can understand that."
    inner "What about making gadgets?"
    me "I think you already gave me the answer to that. I can't see it having an real, essential impact on me."
    me "There's also another problem with it."
    me "It can definitely change the world. It has."
    ...
    inner "Are you looking for an absolute good, then?"
    ...
    me "If I write about something, the only people who will constantly remember it are those whose lives revolve around it - scholars, scientists and such."
    me "By the same token, I think that would rule out fiction. People's lives can't revolve around that."
    inner "Ah, but can't it have an impact? Isn't it inspiring? To you?"
    me "Yeah, that's true."
    ...
    "At first, I can't answer. He has a point, but... something...."
    me "But do people really live differently because of it? Did it really change the world?"
    me "Aside from the film padding some wallets and depleting some others, did Tolkien have a tangible effect on the world? On me?"
    me "I really want to say it did."
    me "An effort like that, a passion like his deserves it."
    me "But I can't see it."
    me "..."
    me "I think the tale was so magical and legendary that it remained trapped in Middle-Earth. It didn't get inside me."
    inner "Hoooo."
    inner "Tricky, tricky, isn't it?"
    inner "For one thing, it's got to inspire you and others."
    inner "{i}And{/i} it has to inspire in a good way."
    inner "And not only that, it's got to inspire in a down-to-earth way."
    me "So..."
    me "...I'll be a tsadik."
    inner "Hahahaha!"
    ...
    inner "In fact, you have already succumbed!"
    ...
    me "{i}Boruch atoh Adonoi, Eloheinu melech haöilom, shehakoil nihiyoh bidvaroi.{/i}"
    mom "{i}Omein.{/i}"
    ...
    me "Giving up on everyth- Well, even making everything second to being a tsadik..."
    me "I don't know if I can do it."
    ...
    # The Lubavitcher Rebbe says that there is a tsadik inside each of us already. We just have to reveal it.
    ...
    inner "Everything he does comes because of his pure inner core."
    ...
    me "{i}Boruch atoh adonoi, eloheinu melech haöilom, boirei nefashos rabos v'chesroinon al kol mo sheboroso lehachayois bohem nefesh kol chai...{/i}"
    ...
    me "Yeah."
    ys "\"Grace After Meals.\" That sounds so... curly!"
    me "You mean, old and fancy?"
    ...
    "And to really get it, I have to go with my core. External is not enough; it's got to be internal."
    ...
    "I knew that it was filtered down some, because the titles and authors clearly indicated their original language."
    ...
    "Or..."
    "...maybe it was because I kept asking questions from the rabbi and kept getting answers."
    ...
    "Maybe it was just that the possibilities and knowledge just waiting out there made me want to go out and get it for myself."
    "There were entire fields of Jewish knowledge that I had no idea about, like Talmud and Kabbalah."
    "But at the same time as I was exhilarated by the knowledge, I was also in awe and a bit of fear of certain deep secrets."
    ...
    "P'shat is the first level - the plain meaning of the verse."
    "Remez is next level: allusion, which links the verses in different places together."
    ...
    "\"They were Ben Azai, Ben Zoima, Acher, and Rabbi Akiva.\""
    "\"He said to them:\""
...
#########################
    ...
    pause
    me "Wait, who's \"he\"?"
    me "I'm in number four. It's not in mishna three... Ah. Mishna two."
    ...
    $mishna = bookText("He used to say, \"Make His Will as your will, so that He will make your will as His Will.\"", "Mishna, Tractate Avos 2:4")
    show text(mishna)
    with dissolve
    pause
    ...
    me "But then, if that's so, and your will at that point is already the same as God's Will, why go further?"
    me "Why does it say, \"so that He will make your will as His\"? They are already the same, or aren't they? What's left to do?"
    me "Or, are they not quite the same yet?"
    me "Hanh."
...
# Chassidus explains that before coming to the level of the "service of a son", one must come to the level of "sevice of a servant" first. Thus, Bartenura says, "Expend... as if... for your own desires." This is service of a servant, where he doesn't feel as much pleasure in his service, which is characterized mostly by awe of Heaven. "If you do this, He will make your will like His Will." You will come to see pleasure in the mitsvos, for your will shall be like His. "He will give you good..." - says the Talmud, "there is no good but Torah." See Tanya ch. 41.
    show text(mishna)
    with dissolve
    ...
    show text(bookText(
        ...
        "Ibid."))
# Perhaps this means, before absorbing Torah, one is constantly looking around him at everyone else, and other people's wills override his own. After one has thoroughly absorbed the Torah, he will rise above being dependent on opinions of others and will be secure in his way. Perhaps we can go further and equate acheirim - others - with the Other Side, the Sitra Achra.
    pause
    ...
    pn "You don't eat this that often, though, do you?"
    ys "Few times a week."
    pn "WHAT!?"
    pn "Look, you've got such a nice build now! You're gonna inflate like a flabby balloon!"
    "Yossi dangerously raises an eyebrow."
    ys "... Flabby?"
    pn "Flabby."
    ys "FLABBY?!"
    pn "Yeah. -AHH!"
    "Faster than I could blink, Yossi jabbed Pinny's sides. Then, after a moment of target acquisition-"
    pn "EEK!"
    "-he got the button."
    ...
    pn "Yossi, I forgot... how dangerous it is to get between you and ice cream."
