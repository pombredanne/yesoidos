label chapter2:
    ...
    me "Besides, even if I developed a device that could stop all war, how long would that last before another technology makes it obsolete?"
    ...
    me "I think that would rule out fiction."
    inner "But can't it have an impact? Isn't it inspiring?"
    me "Yeah, that's true."
    ...
    inner "But you... you are just a puny speck of dust next to them. In an age of darkness."
    ...
    "Sometimes, I read about Gematria, like in the Kitzur Shulchan Aruch, where the author performed numerology with the letters of the Alef-Beis."
